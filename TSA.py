...
header1 = f'{"".center(8)}|{"Results".center(25)}|{"C1 Layer".center(37)}|{"C3 Layer".center(37)}|{"F5 Layer".center(27)}|{"F6 Layer".center(27)}|{"General".center(22)}|'
header2 = f'{"Tree".center(8)}|{"Accuracy".center(12)}|{"Running".center(12)}|{"Number of".center(13)}{"Kernel".center(10)}{"Activation".center(14)}|{"Number of".center(13)}{"Kernel".center(10)}{"Activation".center(14)}|{"Number of".center(13)}{"Activation".center(14)}|{"Number of".center(13)}{"Activation".center(14)}|{"Batch".center(9)}{"Optimizer".center(13)}|'
header3 = f'{"".center(8)}|{"".center(12)}|{"time".center(12)}|{"filters".center(13)}{"size".center(10)}{"function".center(14)}|{"filters".center(13)}{"size".center(10)}{"function".center(14)}|{"neurons".center(13)}{"function".center(14)}|{"neurons".center(13)}{"function".center(14)}|{"size".center(9)}{"".center(13)}|'
...
def TSA(population_size, search_tendency, dimensions, f, search_space, train_set, test_set, filename):
	...
	# print(header2)
	# print(header3)
	trees_values, trees_times, best_tree_index = chooseBest(trees, f, train_set, test_set, 1, filename, verbose = True)
	# print("\t", trees_values)
	print("-" * 190)
	print()
	file = open(filename, 'a')
	...
	for it in range(max_it):
		...
		for current_tree_index in range(population_size):
			...
			seeds_values, seeds_times, best_seed_index = chooseBest(seeds, f, train_set, test_set, 1, filename, verbose = False)
			...
			displayTree(current_tree_index + 1, trees[current_tree_index], trees_values[current_tree_index], trees_times[current_tree_index], filename)
...
def CNN(hyperparameters, train_set, test_set, epochs):
	...
	history = model.fit(train_images, train_labels, batch_size=batch_size, epochs=epochs, verbose=0)
...
def displayTree(index, tree, value, time, filename):
	...
	C2_kernel_size = kernel_size[C2_kernel_size]
	optimizer = optimizers[optimizer]
	string = f'{str(index).center(8)}|{str(sf.round(value, sigfigs=8)).center(12)}|{str(sf.round(time, sigfigs=8)).center(12)}|{str(C1_num_filter).center(13)}{str(C1_kernel_size).center(10)}{C1_activation.center(14)}|{str(C2_num_filter).center(13)}{str(C2_kernel_size).center(10)}{C2_activation.center(14)}|{str(FC1_neuron).center(13)}{FC1_activation.center(14)}|{str(FC2_neuron).center(13)}{FC2_activation.center(14)}|{str(batch_size).center(9)}{optimizer.center(13)}|'
	print(string)
	file = open(filename, 'a')
	file.write(string + '\n')
	file.close()
